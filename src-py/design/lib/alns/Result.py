...
class Result:
    ...
    def plot_objectives(
        ...
        **kwargs: Dict[str, Any]
        ...
        # First call is current solution objectives (at each iteration), 
        # Second call is the best solution found so far (as a running minimum).
        ax.plot(self.statistics.objectives, **kwargs)
        # if ALNS.optimization_direction == "maximize":
        ...
        ax.legend(["Current"], loc="upper right")
